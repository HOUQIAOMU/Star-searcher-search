...
if("TRUE" STREQUAL "TRUE")
  set(poscmd_2_odom_SOURCE_PREFIX /home/jacob/star-searcher/src/STAR-Searcher/Star-Searcher/search_planner/uav_simulator/poscmd_2_odom)
  set(poscmd_2_odom_DEVEL_PREFIX /home/jacob/star-searcher/devel)
  ...
  set(poscmd_2_odom_INSTALL_PREFIX /home/jacob/star-searcher/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'poscmd_2_odom' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jacob/star-searcher/src/STAR-Searcher/Star-Searcher/search_planner/uav_simulator/poscmd_2_odom/${idir}'.  ${_report}")
    endif()
