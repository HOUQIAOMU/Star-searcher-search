...
if("TRUE" STREQUAL "TRUE")
  set(local_sensing_node_SOURCE_PREFIX /home/jacob/star-searcher/src/STAR-Searcher/Star-Searcher/search_planner/uav_simulator/local_sensing)
  set(local_sensing_node_DEVEL_PREFIX /home/jacob/star-searcher/devel)
  ...
  set(local_sensing_node_INSTALL_PREFIX /home/jacob/star-searcher/install)
...
if(NOT "/usr/include/opencv4 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'local_sensing_node' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jacob/star-searcher/src/STAR-Searcher/Star-Searcher/search_planner/uav_simulator/local_sensing/${idir}'.  ${_report}")
    endif()
