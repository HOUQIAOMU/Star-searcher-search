...
add_custom_target(_rotors_comm_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rotors_comm" "/home/jacob/star-searcher/src/STAR-Searcher/Star-Searcher/rotors_simulator/rotors_comm/msg/WindSpeed.msg" "std_msgs/Header:geometry_msgs/Vector3"
)
...
add_custom_target(_rotors_comm_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rotors_comm" "/home/jacob/star-searcher/src/STAR-Searcher/Star-Searcher/rotors_simulator/rotors_comm/srv/Octomap.srv" "std_msgs/Header:geometry_msgs/Point:octomap_msgs/Octomap"
)
